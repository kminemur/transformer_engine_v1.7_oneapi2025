...
class ResidualForwardInferenceBlock : public IBlock {
   public:
     ...
     */
    ResidualForwardInferenceBlock(dpct::dnnl::engine_ext &handle, ResidualBlockParams const &params)
   ...
   private:
    ...
    createConvTensors() {
        ...
        for (int i = ResidualBlockParams::ForwardLocation::ZERO; i < ResidualBlockParams::ForwardLocation::COUNT; i++) {
            ...
            generateStrides(tensor_params.input_dim,
                            tensor_params.input_stride,
            ...
            generateStrides(tensor_params.weight_dim,
                            tensor_params.weight_stride,
                            tensor_params.dim_count,
                            dpct::dnnl::memory_format_tag::nhwc);
            ...
            generateStrides(tensor_params.output_dim,
                            tensor_params.output_stride,
                            tensor_params.dim_count,
                            dpct::dnnl::memory_format_tag::nhwc);
    ...
    configureProblems() {
        ...
        auto scale_descriptor =
            /*
            DPCT1007:946: Migration of CUDNN_POINTWISE_MUL is not supported.
            */
        ...
        auto relu = PointWiseDescBuilder()
                        /*
                        DPCT1007:947: Migration of CUDNN_POINTWISE_RELU_FWD is not supported.
                        */
        ...
        /*
        DPCT1007:948: Migration of CUDNN_POINTWISE_ADD is not supported.
        */
        ...
        /*
        DPCT1007:949: Migration of CUDNN_POINTWISE_SUB is not supported.
        */
        ...
        /*
        DPCT1007:950: Migration of CUDNN_POINTWISE_RSQRT is not supported.
        */
        ...
        for (int i = ResidualBlockParams::ForwardLocation::ZERO; i < ResidualBlockParams::ForwardLocation::COUNT; i++) {
            ...
            SubGraph convolution_subgraph = {
                {"conv" + std::to_string(i),
                 /*
                 DPCT1007:951: Migration of CUDNN_BACKEND_OPERATION_CONVOLUTION_FORWARD_DESCRIPTOR is not supported.
                 */
                ...
                {"conv_input_descale" + std::to_string(i),
                 /*
                 DPCT1007:952: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                 */
                ...
                {"conv_weight_descale" + std::to_string(i),
                 /*
                 DPCT1007:953: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                 */
                 cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                 "scale",
                 {"CONV::AfterXDescale" + std::to_string(i),
                ...
                {"conv_output_scale" + std::to_string(i),
                 /*
                 DPCT1007:954: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                 */
                 cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                 "scale",
                 {"CONV::AfterWDescale" + std::to_string(i),
                ...
                {"amax" + std::to_string(i),
                 /*
                 DPCT1007:955: Migration of CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR is not supported.
                 */
            ...
            if (i == ResidualBlockParams::ForwardLocation::ZERO || i == ResidualBlockParams::ForwardLocation::ONE) {
                SubGraph bn_subgraph = {
                    {"BN_input_descale" + std::to_string(i),
                     /*
                     DPCT1007:956: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                    ...
                    {"BN_sub_mean" + std::to_string(i),
                     /*
                     DPCT1007:957: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "sub",
                     {"BN::X_HP_" + std::to_string(i),
                    ...
                    {"BN_eps_add" + std::to_string(i),
                     /*
                     DPCT1007:958: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "Add",
                    ...
                    {"BN_rsqrt_var" + std::to_string(i),
                     /*
                     DPCT1007:959: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "rsqrt",
                    ...
                    {"BN_N_X" + std::to_string(i),
                     /*
                     DPCT1007:960: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::X_SUB_MeanTensor_" + std::to_string(i),
                    ...
                    {"BN_MUL_S" + std::to_string(i),
                     /*
                     DPCT1007:961: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::N_X_" + std::to_string(i),
                    ...
                    {"BN_ADD_B" + std::to_string(i),
                     /*
                     DPCT1007:962: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "Add",
                     {"BN::N_X_MUL_S_" + std::to_string(i),
                    ...
                    {"BN_op_relu" + std::to_string(i),
                     /*
                     DPCT1007:963: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "ReLU",
                    ...
                    {"BN_op_scale" + std::to_string(i),
                     /*
                     DPCT1007:964: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                    ...
                    {"BN_amax" + std::to_string(i),
                     /*
                     DPCT1007:965: Migration of CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR,
                     "amax",
                ...
                SubGraph bn_subgraph = {
                    {"BN_input_descale" + std::to_string(i),
                     /*
                     DPCT1007:966: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::X_" + std::to_string(i),
                    ...
                    {"BN_sub_mean" + std::to_string(i),
                     /*
                     DPCT1007:967: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "sub",
                     {"BN::X_HP_" + std::to_string(i),
                    ...
                    {"BN_eps_add" + std::to_string(i),
                     /*
                     DPCT1007:968: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "Add",
                     {"BN::VarTensor_" + std::to_string(i),
                    ...
                    {"BN_rsqrt_var" + std::to_string(i),
                     /*
                     DPCT1007:969: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "rsqrt",
                     {"BN::VAR_ADD_EPS_" + std::to_string(i), "BN::RSQRT_VAR_" + std::to_string(i)}},
                    {"BN_N_X" + std::to_string(i),
                     /*
                     DPCT1007:970: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::X_SUB_MeanTensor_" + std::to_string(i),
                    ...
                    {"BN_MUL_S" + std::to_string(i),
                     /*
                     DPCT1007:971: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::N_X_" + std::to_string(i),
                    ...
                    {"BN_ADD_B" + std::to_string(i),
                     /*
                     DPCT1007:972: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "Add",
                     {"BN::N_X_MUL_S_" + std::to_string(i),
                    ...
                    {"BN_op_descale" + std::to_string(i),
                     /*
                     DPCT1007:973: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                    ...
                    {"BN_op_add" + std::to_string(i),
                     /*
                     DPCT1007:974: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "Add",
                     {"BN::Y_HP_" + std::to_string(i),
                    ...
                    {"BN_op_relu" + std::to_string(i),
                     /*
                     DPCT1007:975: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "ReLU",
                    ...
                    {"BN_op_scale" + std::to_string(i),
                     /*
                     DPCT1007:976: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::afterRelu_" + std::to_string(i),
                    ...
                    {"BN_amax" + std::to_string(i),
                     /*
                     DPCT1007:977: Migration of CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR,
                     "amax",
                     {"BN::afterRelu_" + std::to_string(i), "BN::Y_AMAX_" + std::to_string(i)}}};
                ...
                SubGraph bn_subgraph = {
                    {"BN_input_descale" + std::to_string(i),
                     /*
                     DPCT1007:978: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::X_" + std::to_string(i),
                    ...
                    {"BN_sub_mean" + std::to_string(i),
                     /*
                     DPCT1007:979: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "sub",
                     {"BN::X_HP_" + std::to_string(i),
                    ...
                    {"BN_eps_add" + std::to_string(i),
                     /*
                     DPCT1007:980: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "Add",
                     {"BN::VarTensor_" + std::to_string(i),
                    ...
                    {"BN_rsqrt_var" + std::to_string(i),
                     /*
                     DPCT1007:981: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "rsqrt",
                     {"BN::VAR_ADD_EPS_" + std::to_string(i), "BN::RSQRT_VAR_" + std::to_string(i)}},
                    {"BN_N_X" + std::to_string(i),
                     /*
                     DPCT1007:982: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::X_SUB_MeanTensor_" + std::to_string(i),
                    ...
                    {"BN_MUL_S" + std::to_string(i),
                     /*
                     DPCT1007:983: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::N_X_" + std::to_string(i),
                    ...
                    {"BN_ADD_B" + std::to_string(i),
                     /*
                     DPCT1007:984: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "Add",
                     {"BN::N_X_MUL_S_" + std::to_string(i),
                    ...
                    {"BN_op_scale" + std::to_string(i),
                     /*
                     DPCT1007:985: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR,
                     "scale",
                     {"BN::Y_HP_" + std::to_string(i),
                    ...
                    {"BN_amax" + std::to_string(i),
                     /*
                     DPCT1007:986: Migration of CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR is not supported.
                     */
                     cudnnBackendDescriptorType_t::CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR,
                     "amax",
    ...
    dpct::err1
    buildOpGraph(dpct::dnnl::engine_ext &handle, SubGraph const &sub_graph, const std::string &graph_name) override {
        getLogger() << "[cudnn_frontend] "
        ...
        for (auto &node : sub_graph) {
            ...
            switch (node.type) {
                ...
                /*
                DPCT1007:987: Migration of CUDNN_BACKEND_OPERATION_CONVOLUTION_FORWARD_DESCRIPTOR is not supported.
                */
                ...
                /*
                DPCT1007:988: Migration of CUDNN_BACKEND_OPERATION_POINTWISE_DESCRIPTOR is not supported.
                */
                ...
                /*
                DPCT1007:989: Migration of CUDNN_BACKEND_OPERATION_REDUCTION_DESCRIPTOR is not supported.
                */
