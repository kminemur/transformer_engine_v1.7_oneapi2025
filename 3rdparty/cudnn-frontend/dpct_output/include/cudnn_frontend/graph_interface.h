...
class Graph : public INode {
   ...
   public:
    ...
    error_t
    check_support(dpct::dnnl::engine_ext h) {
    ...
    error_t
    build_plans(dpct::dnnl::engine_ext const &handle,
                BuildPlanPolicy_t const policy     = BuildPlanPolicy_t::HEURISTICS_CHOICE,
                bool const do_multithreaded_builds = false);

    error_t
    build_plan_at_index(dpct::dnnl::engine_ext const &handle, int64_t index);
...
inline error_t
Graph::build_plan_at_index(dpct::dnnl::engine_ext const &handle, int64_t plan_index) {
...
inline error_t
Graph::build_plans(dpct::dnnl::engine_ext const &handle,
