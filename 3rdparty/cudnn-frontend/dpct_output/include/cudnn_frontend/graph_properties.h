...
class Tensor_attributes {
   public:
    ...
    using pass_by_values_t = std::variant<int32_t, sycl::half, float, sycl::ext::oneapi::bfloat16>;
   ...
   public:
    ...
    Tensor_attributes(sycl::half const& scalar) {
        pass_by_value    = scalar;
        is_pass_by_value = true;
        dim = stride = {1};
    ...
    Tensor_attributes(sycl::ext::oneapi::bfloat16 const& scalar) {
        pass_by_value    = scalar;
        is_pass_by_value = true;
        dim = stride = {1};
