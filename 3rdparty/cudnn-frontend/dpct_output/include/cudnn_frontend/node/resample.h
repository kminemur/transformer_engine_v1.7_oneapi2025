...
class ResampleNode : public NodeCRTP<ResampleNode> {
   public:
    ...
    pre_validate_node() const override final {
        ...
        RETURN_CUDNN_FRONTEND_ERROR_IF(detail::convert_to_cudnn_type(attributes.resample_mode, dummy) != 0,
                                       error_code_t::ATTRIBUTE_NOT_SET,
    ...
    create_cudnn_operations(
        ...
        try {
            ...
            /*
            DPCT1007:759: Migration of CUDNN_BACKEND_API_FAILED is not supported.
            */
