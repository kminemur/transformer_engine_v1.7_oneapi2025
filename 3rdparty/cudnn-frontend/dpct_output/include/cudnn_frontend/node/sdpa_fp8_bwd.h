...
class SDPAFP8BackwardNode : public NodeCRTP<SDPAFP8BackwardNode> {
   ...
   public:
    ...
    error_t
    pre_validate_node() const override final try {
        ...
        /*
        DPCT1005:768: The SYCL device version is different from CUDA Compute Compatibility. You may need to rewrite this
        code.
        */
        RETURN_CUDNN_FRONTEND_ERROR_IF(
            prop.get_major_version() < 9,
            error_code_t::GRAPH_NOT_SUPPORTED,
