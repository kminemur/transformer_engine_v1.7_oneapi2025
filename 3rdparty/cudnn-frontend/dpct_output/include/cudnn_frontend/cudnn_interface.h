...
class ICudnn {
   protected:
    ...
    create_cudnn_tensor(std::shared_ptr<graph::Tensor_attributes> const& props,
        ...
        try {
            ...
            /*
            DPCT1007:736: Migration of CUDNN_BACKEND_API_FAILED is not supported.
            */
            RETURN_CUDNN_FRONTEND_ERROR_IF(e.getCudnnStatus() != 0, error_code_t::CUDNN_BACKEND_API_FAILED, e.what());
        }
#endif
    ...
    error_t
    create_cudnn_operation_graphs(dpct::dnnl::engine_ext handle) {
        ...
        try {
            ...
            /*
            DPCT1007:737: Migration of CUDNN_BACKEND_API_FAILED is not supported.
            */
            RETURN_CUDNN_FRONTEND_ERROR_IF(e.getCudnnStatus() != 0, error_code_t::CUDNN_BACKEND_API_FAILED, e.what());
        }
#endif
   ...
   public:
    ...
    error_t
    execute_cudnn_plans_with_uid(dpct::dnnl::engine_ext handle,
