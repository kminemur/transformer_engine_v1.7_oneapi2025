...
function(find_cudnn_library NAME)
    find_library(
        ...
        HINTS $ENV{CUDNN_PATH} ${CUDNN_PATH} ${Python_SITEARCH}/nvidia/cudnn ${SYCLToolkit_LIBRARY_DIR}
    ...
    if(${NAME}_LIBRARY)
        ...
        set_target_properties(
            CUDNN::${NAME} PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${CUDNN_INCLUDE_DIR}
...
target_include_directories(
    ...
    $<BUILD_INTERFACE:${SYCL_INCLUDE_DIR}>
)
